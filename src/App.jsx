    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg" >
          ...
          <p className="font-lexend mb-7 text-offwhite">
          ...
          <a  className="font-lexend bg-offwhite  block px-10 py-3 w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/sedans" target="_blank">ver mais</a>
        </div>
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-offwhite  block px-10 py-3 w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/SUVs" target="_blank">ver mais</a>
        </div>
